...
- [ ] Разобрать минусы нормализации и зачем нужна денормализация
- [ ] (15 минут) Посмотреть, как реализовать полнотекстовый поиск на сайте: PostgreSQL + pg_trgm + GIN vs ElasticSearch
...
##### Практические продуктовые задачи с собеседований
